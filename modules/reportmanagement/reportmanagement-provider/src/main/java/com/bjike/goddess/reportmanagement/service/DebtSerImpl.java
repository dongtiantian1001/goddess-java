...
import com.bjike.goddess.reportmanagement.entity.DebtTemp;
...
import static com.bjike.goddess.common.utils.date.DateUtil.parseTime;
...
public class DebtSerImpl extends ServiceImpl<Debt, DebtDTO> implements DebtSer {
    ...
    public List<DebtBO> list(DebtDTO dto) throws SerException {
        ...
        String token = dto.getToken()== null?RpcTransmit.getUserToken():dto.getToken();
        dto.setToken(token);
        checkSeeIdentity();
        ...
        if (dto.isLastest()==false) {
            ...
            sql1.append("select createTime,modifyTime,beginAsset,endAsset,endTime,num,project,startTime,systemId,projectId from reportmanagement_assetdebttemp where 1=1");
            sql1.append(" and startTime >='"+dto.getStartTime()+"' and ");
            sql1.append("endTime <= '"+dto.getEndTime()+"'");
            String[] files = new String[]{"createTime","modifyTime","beginAsset","endAsset","endTime","num","project","startTime","systemId","projectId"};
            List<DebtTemp> debt = super.findBySql(sql1.toString(),DebtTemp.class,files);
            //如果第一次为空直接从负债表中取
            if(null == debt || debt.size() == 0){
                StringBuffer sql = new StringBuffer();
                sql.append("select createTime,modifyTime,beginAsset,endAsset,endTime,num,project,startTime,systemId,projectId from reportmanagement_assetdebtdata where 1=1");
                sql.append(" and startTime >='"+dto.getStartTime()+"' and ");
                sql.append("endTime <= '"+dto.getEndTime()+"'");
                String[] fields = new String[]{"createTime","modifyTime","beginAsset","endAsset","endTime","num","project","startTime","systemId","projectId"};
                List<AssetDebtData> debtData = super.findBySql(sql.toString(),AssetDebtData.class,fields);
                    if(null != debtData  && debtData.size() != 0){
                    for (AssetDebtData data : debtData) {
        ...
        for (DebtBO bo : boList) {
            ...
            data.setEndAsset(bo.getEndDebt() == null ? new BigDecimal(0.0).doubleValue() : new BigDecimal(bo.getEndDebt()).doubleValue());
            data.setBeginAsset(bo.getBeginDebt() == null ? new BigDecimal(0.0).doubleValue() : new BigDecimal(bo.getBeginDebt()).doubleValue());
    ...
    List<DebtBO> convertDebt(List<DebtBO> list) {
        ...
        for (DebtBO bo : list) {
            ...
            if ("短期借款".equals(bo.getDebt())) {
                bo2 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 1, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("应付票据".equals(bo.getDebt())) {
                bo3 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 2, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("应付账款".equals(bo.getDebt())) {
                bo4 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 3, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("预收账款".equals(bo.getDebt())) {
                bo5 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 4, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("应付职工薪酬".equals(bo.getDebt())) {
                bo6 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 5, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("应付利息".equals(bo.getDebt())) {
                bo7 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 6, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("应付股利".equals(bo.getDebt())) {
                bo8 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 7, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("应交税金".equals(bo.getDebt())) {
                bo9 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 8, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("其他应交款".equals(bo.getDebt())) {
                bo10 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 9, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("其他应付款".equals(bo.getDebt())) {
                bo11 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 10, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("预提费用".equals(bo.getDebt())) {
                bo12 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 11, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("预计负债".equals(bo.getDebt())) {
                bo13 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 12, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("一年内到期的长期负债".equals(bo.getDebt())) {
                bo14 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 13, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("其他流动负债".equals(bo.getDebt())) {
                bo15 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 14, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
                bo16 = new DebtBO();
            }
            if ("流动负债合计".equals(bo.getDebt())) {
                bo17 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 15, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            ...
            if ("长期借款".equals(bo.getDebt())) {
                bo19 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(),16, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("应付债券".equals(bo.getDebt())) {
                bo20 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 17, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("长期应付款".equals(bo.getDebt())) {
                bo21 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 18, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("专项应付款".equals(bo.getDebt())) {
                bo22 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 19, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("其他长期负债".equals(bo.getDebt())) {
                bo23 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 20, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("长期负债合计".equals(bo.getDebt())) {
                bo24 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 21, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            ...
            if ("递延税款贷项".equals(bo.getDebt())) {
                bo26 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 22, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("负债合计".equals(bo.getDebt())) {
                bo27 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 23, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
                bo28 = new DebtBO();
            }
            ...
            if ("实收资本(或股本)".equals(bo.getDebt()) || "实收资本（或股本）".equals(bo.getDebt())) {
                bo30 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 24, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("减：已归还投资".equals(bo.getDebt()) || "减:已归还投资".equals(bo.getDebt())) {
                bo31 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 25, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("实收资本(或股本)净额".equals(bo.getDebt()) || "实收资本（或股本）净额".equals(bo.getDebt())) {
                bo32 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(),26, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("资本公积".equals(bo.getDebt())) {
                bo33 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 27, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("盈余公积".equals(bo.getDebt())) {
                bo34 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 28, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("其中：法定公益金".equals(bo.getDebt()) || "其中:法定公益金".equals(bo.getDebt())) {
                bo35 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 29, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("未分配利润".equals(bo.getDebt())) {
                bo36 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 30, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("所有者权益(或股东权益)合计".equals(bo.getDebt()) || "所有者权益（或股东权益）合计".equals(bo.getDebt())) {
                bo37 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 31, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
            if ("负债和所有者权益（或股东权益）总计".equals(bo.getDebt()) || "负债和所有者权益(或股东权益)总计".equals(bo.getDebt())) {
                bo38 = new DebtBO(bo.getId(), bo.getStartTime(), bo.getEndTime(), bo.getDebt(), bo.getDebtType(), bo.getType(), 32, bo.getBeginDebt(), bo.getCurrent(), bo.getEndDebt());
            }
        }
...
//                bo.setCurrent(formulaBO.getCurrent());
            ...
            String debts = "0";
            if (0d != countCurrent) {
                debts = String.format("%.2f", (debtBO.getFee() / countCurrent) * 100);
            }
            debtBO.setScale(debts + "%");
            boList.add(debtBO);
