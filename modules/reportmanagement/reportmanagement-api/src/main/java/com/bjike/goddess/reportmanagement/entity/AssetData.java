...
public class AssetData extends BaseEntity {
    ...
    public AssetData(LocalDate startTime, LocalDate endTime, String project, Integer num, Double beginAsset, Double endAsset, AssetType assetType, Type type, String systemId) {
